...
class AdminInstructorUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => ['required', 'string', 'lowercase', 'email', 'max:255', Rule::unique(User::class, 'email')->ignore($this->route('instructor'))],
