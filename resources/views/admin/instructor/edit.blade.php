            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.instructor.index') }}" class="btn btn-dark px-2 py-1 px-md-3 py-md-2">
                        ...
                        <form action="{{ route('admin.instructor.update', $instructor->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 align-items-stretch">
                                <div class="col-xl-6">
                                    ...
                                    <img src="{{ asset($instructor->image) }}" style="width: 150px !important; height: 150px !important; object-fit: contain !important; display: inline-block !important;">
                                ...
                                <div class="col-xl-6 d-flex flex-column">
                                    <div class="general_form_input mt-auto"> 
                                        ...
                                        <select class="form-control form-select" name="college_id">
                                            ...
                                            <option @selected($instructor->college_id == $college->id) value="{{ $college->id }}">{{ $college->name }}</option>
                                            @endforeach
                                        </select>
