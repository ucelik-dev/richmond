                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="number" name="commission_percent" value="{{ old('commission_percent') }}" class="form-control">
                                        <x-input-error :messages="$errors->get('commission_percent')" class="mt-2 text-danger small" />
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="number" name="commission_amount" value="{{ old('commission_amount') }}" class="form-control">
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="number" name="discount_percent" value="{{ old('discount_percent') }}" class="form-control">
