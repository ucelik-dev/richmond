        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">MANAGER UPDATE</h3>
                    <div class="card-actions">
                        <a href="{{ route('admin.manager.index') }}" class="btn btn-dark px-2 py-1 px-md-3 py-md-2">
                        ...
                        <form action="{{ route('admin.manager.update', $manager->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 align-items-stretch">
                                <div class="col-xl-6">
                                    ...
                                    <img src="{{ asset($manager->image) }}" style="width: 150px !important; height: 150px !important; object-fit: contain !important; display: inline-block !important;">
                                ...
                                <div class="col-xl-6 d-flex flex-column">
                                    <div class="general_form_input mt-auto"> 
                                        ...
                                        <select class="form-control form-select" name="college_id">
                                            ...
                                            <option @selected($manager->college_id == $college->id) value="{{ $college->id }}">{{ $college->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="gender">
                                            <option @selected($manager->gender == 'male') value="male">Male</option>
                                            <option @selected($manager->gender == 'female') value="female">Female</option>
                                            <option @selected($manager->gender == 'other') value="other">Other</option>
                                        </select>
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <input type="date" name="dob" value="{{ $manager->dob }}" class="form-control">
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="contact_email" value="{{ $manager->contact_email }}" class="form-control">
                            ...
                            <div class="row">
                                    ...
                                    <div class="general_form_input">
                                        ...
                                        <select name="country_id" class="form-control form-select">
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" {{ old('country_id', $manager->country_id) == $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="city" value="{{ $manager->city }}" class="form-control">
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="post_code" value="{{ $manager->post_code }}" class="form-control">
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="account_status">
                                            <option @selected($manager->account_status == 1) value="1">Active</option>
                                            <option @selected($manager->account_status == 0) value="0">Inactive</option>
                                        </select>
                                    ...
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="user_status_id">
                                            @foreach ($userStatuses as $userStatus)
                                                <option @selected($userStatus->id === $manager->user_status_id) value="{{ $userStatus->id }}">{{ ucwords($userStatus->name) }}</option>
                                            @endforeach
                                        </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 table-responsive">
                                                            ...
                                                            <table class="table table-bordered" id="documentTable">
                                                                ...
                                                                <tbody>
                                                                    @foreach($manager->documents as $index => $document)
                                                                        <tr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 table-responsive">
                                                            ...
                                                            <table class="table table-bordered" id="userNotesTable">
                                                                ...
                                                                <tbody>
                                                                    @foreach($manager->userNotes ?? [] as $index => $note)
                                                                        <tr>
...
@push('scripts')
    ...
    {{-- Edit note script --}}
    <script>
        let noteIndex = {{ count($manager->userNotes ?? []) }};
