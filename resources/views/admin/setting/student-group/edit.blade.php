        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto text-end">
                    <a href="{{ route('admin.setting-student-group.index') }}" class="btn btn-dark px-2 py-1 px-md-3 py-md-2">
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">STUDENT GROUP UPDATE</h3>
                </div>
                <div class="card-body">

                    <div class="add_course_basic_info">

                        <form action="{{ route('admin.setting-student-group.update', $group->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="general_form_input">
                                    ...
                                    <select class="form-control form-select" name="instructor_id">
                                        ...
                                        @foreach ($instructors as $instructor)
                                                <option @selected($group->instructor_id === $instructor->id) value="{{ $instructor->id }}" {{ old('instructor_id') == $instructor->id ? 'selected' : '' }}>{{ $instructor->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="status">
                                            <option @selected($group->status == 1) value="1">Active</option>
                                            <option @selected($group->status == 0) value="0">Inactive</option>
                                        </select>
