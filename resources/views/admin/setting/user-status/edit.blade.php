        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">USER STATUS UPDATE</h3>
                </div>
                <div class="card-body">

                    <div class="add_course_basic_info">

                        <form action="{{ route('admin.setting-user-status.update', $userStatus->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="name" value="{{ $userStatus->name }}" class="form-control">
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="color" value="{{ $userStatus->color }}" class="form-control">
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="status">
                                            <option @selected($userStatus->status == 1) value="1">Active</option>
                                            <option @selected($userStatus->status == 0) value="0">Inactive</option>
                                        </select>
                                ...
                                <div class="col-xl-3">
                                    <div class="general_form_input">
                                        ...
                                        <input type="text" name="order" value="{{ $userStatus->order }}" class="form-control">
