                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <textarea rows="8" name="bank_account" class="form-control summernote">{{ $college->bank_account }}</textarea>
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <textarea rows="8" name="invoice_data" class="form-control summernote">{{ $college->invoice_data }}</textarea>
