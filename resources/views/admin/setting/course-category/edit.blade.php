        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">COURSE CATEGORY UPDATE</h3>
                </div>
                <div class="card-body">

                    <div class="add_course_basic_info">

                        <form action="{{ route('admin.setting-course-category.update', $courseCategory->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-xl-6">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="status">
                                            <option @selected($courseCategory->status == 1) value="1">Active</option>
                                            <option @selected($courseCategory->status == 0) value="0">Inactive</option>
                                        </select>
