        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto text-end">
                    <a href="{{ route('admin.setting-country.index') }}" class="btn btn-dark px-2 py-1 px-md-3 py-md-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="add_course_basic_info">
                        ...
                        <form action="{{ route('admin.setting-country.update', $country->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-xl-4">
                                    <div class="general_form_input">
                                        ...
                                        <select class="form-control form-select" name="status">
                                            <option @selected($country->status == 1) value="1">Active</option>
                                            <option @selected($country->status == 0) value="0">Inactive</option>
                                        </select>
