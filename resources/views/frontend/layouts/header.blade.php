    ...
    <nav class="navbar navbar-expand-lg main_menu main_menu_3">
        <a class="navbar-brand" href="index_3.html">
            <img src="{{ asset('frontend/assets/images/logo2.png') }}" alt="Richmond" class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('courses.index') }}">Courses <i class="far fa-angle-down"></i></a>
                    <ul class="droap_menu">
            ...
            @else
                @if(auth()->user())
                    <li>
                        <a class="common_btn" href="javascript:;" onclick="event.preventDefault();  $('#logout').submit();">Sign out</a>
                    </li>
                @endif
            @endif
        </div>
