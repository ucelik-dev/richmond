                ...
                <div class="col-xl-10 col-md-8 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    ...
                    <div class="wsus__dashboard_content">
                        ...
                        <div class="wsus__dash_course_table">
                            ...
                            <form
                                action="{{ route('instructor.finance.update', $instructor->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="align-middle p-1">
                                                                <textarea rows="8" name="bank_account" class="form-control summernote">{{ $instructor->bank_account }}</textarea>
                                            ...
                                            <div class="table-responsive p-1 border rounded">
                                                <table class="table table-bordered" id="documentsTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="align-middle p-1">
                                                                <textarea rows="8" name="invoice_data" class="form-control summernote">{{ $instructor->invoice_data }}</textarea>
                                        ...
                                        @if(auth()->user()?->canResource('instructor_finance','edit'))
