                ...
                <div class="col-xl-10 col-md-8 pt-0 mt-0">
                    ...
                    {{-- @if(auth()->user()->account_status === 1)
                        ...
                        <div class="alert alert-danger d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Hi {{ auth()->user()->company ?? auth()->user()->name }}! Your application is currently <b>inactive</b>. We will send you an email when it is approved.
                            </div>
                        </div>
                    @endif --}}

                    <p class="fw-medium fs-6">{{ auth()->user()->company ?? auth()->user()->name }}</p>
                    <hr class="mt-1">
