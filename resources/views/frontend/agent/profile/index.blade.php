            ...
            <div class="row">
                ...
                <div class="col-xl-10 col-md-8 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    ...
                    <div class="wsus__dashboard_content">
                        ...
                        <form action="{{ route('agent.profile.update') }}" method="POST"  class="wsus__dashboard_profile_update">
                            @csrf
                    ...
                    <div class="wsus__dashboard_content">
                        ...
                        <form action="{{ route('agent.profile.update-password') }}" method="POST"
                    ...
                    <div class="wsus__dashboard_content">
                        ...
                        <form action="{{ route('agent.profile.update-social') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12 table-responsive">
                                    <table class="table table-bordered" id="socialAccountsTable">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $savedAccount = $agentSocialAccounts[$socialPlatform->id] ?? null;
                                            @endphp
                                                <tr>
