              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                ...
                <tr>
                    <td class="wrapper">
                      ...
                      <p>Your account at Richmond College has been successfully created.</p>

                      <p>Email: {{ $student->email }}</p>
                      <p>Please <a href="https://learn.richmondcollege.co.uk/customer/account/login">log in</a> to access your dashboard.</p>
